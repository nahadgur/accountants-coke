...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    kind: 'spoke',
    hub: 'accounting-jobs-in-kenya',
    title: '100 Ways to Get an Accounting Job in Kenya',
    metaTitle: '100 Ways to Get an Accounting Job in Kenya',
    description:
      '100 practical, numbered ways to get an accounting job in Kenya, grouped into qualifications, CV, job search, networking, experience, skills, applications and interviews, each a concrete action you can take.',
    lead: 'Getting an accounting job in Kenya is less about one big move and more about doing many small things right. Below are 100 concrete, numbered actions, grouped by theme, that move you from looking to hired. Work through the ones you have not done rather than reading them all at once.',
    updated: '2026-07-06',
    sections: [
      {
        id: 'intro',
        ...
        body: [
          'This is the tactical companion to the guide on [finding and landing accounting jobs in Kenya](/guides/accounting-jobs-in-kenya), which explains how the market is shaped; here the focus is purely on actions. Not every item applies to every person, so treat the list as a menu: find the categories where you are weakest, whether that is qualifications, your CV, your network or your interview technique, and start there.',
          'The actions are grouped from getting your credentials in order through to staying the course, roughly the sequence a job search follows. Wherever an action needs more depth, it links to the fuller guide on that step.',
        ],
      },
      {
        id: 'qualify',
        heading: 'Get your qualifications in order',
        body: [
          'Most listings filter first on credentials, so this is where a weak candidacy is often lost before anything else is read.',
        ],
        qa: [
          { q: '1. Finish your CPA, or show clear progress.', a: 'Many listings accept CPA in progress, so state your stage and the papers you have passed prominently rather than hiding them.' },
          { q: '2. Register as a KASNEB student early.', a: 'Registering with [KASNEB](https://www.kasneb.or.ke/cpa) lets you sit papers and signals a serious path even before you qualify.' },
          { q: '3. Sit the next available CPA paper rather than waiting.', a: 'Momentum on the papers is itself a hiring signal; a stalled candidate can read as a stalled career.' },
          { q: '4. Join ICPAK once you are eligible.', a: 'Membership of [ICPAK](https://www.icpak.com/member-categories/) is asked for on senior roles and gives you CPD and a professional network.' },
          { q: '5. Keep your student or associate membership current.', a: 'A lapsed membership raises a flag, so keep it paid and list it on your CV.' },
          { q: '6. Add a relevant degree or diploma if you can.', a: 'A commerce or finance qualification widens your options, though CPA with a diploma also qualifies you for most roles.' },
          { q: '7. Match your qualification level to the role.', a: 'Applying two rungs above your stage rarely works, so target listings pitched at where you actually are.' },
          { q: '8. Get a technician-level certificate if you are just starting.', a: 'An accounting technician credential opens support roles while you work towards full CPA.' },
          { q: '9. Specialise once you have a base.', a: 'Depth in tax, audit or IFRS makes you the obvious pick for roles that need it.' },
          { q: '10. Keep your CPD hours logged.', a: 'Continuing professional development shows you stay current, so record it and mention it.' },
          { q: '11. Learn the Kenyan reporting framework.', a: 'Comfort with IFRS and IFRS for SMEs is expected on the job, so name it where relevant.' },
          { q: '12. Make sure your certificates are verifiable.', a: 'Employers check KASNEB and ICPAK status, so ensure yours stands up to a look.' },
        ],
      },
      {
        id: 'cv',
        heading: 'Build a CV and documents that get shortlisted',
        body: [
          'Most applications are filtered before a person reads them, so the first job of your documents is to survive that screen. The full method is in the guide to an [accounting CV in Kenya](/blog/accounting-cv-kenya).',
        ],
        qa: [
          { q: '13. Build a results-led CV.', a: 'Lead each role with what you delivered rather than a list of duties, so your impact is what a recruiter sees first.' },
          { q: '14. Tailor the CV to each listing.', a: 'Mirror the wording of the listing so both the human screener and any automated filter recognise the match.' },
          { q: '15. Put your CPA stage near the top.', a: 'Recruiters scan for it first, so do not bury it on the second page.' },
          { q: '16. Quantify your achievements.', a: 'A line like "cut the month-end close from ten days to six" beats "responsible for month-end".' },
          { q: '17. Keep it to two pages.', a: 'A tight, relevant two pages outperforms a padded four every time.' },
          { q: '18. Fix the basics: no typos, clean layout.', a: 'In accounting, a careless CV implies careless work, and screeners read it that way.' },
          { q: '19. Write a short, specific cover note.', a: 'Three lines on why this role and what you bring beats a generic template.' },
          { q: '20. Name your software and tools.', a: 'List the QuickBooks, Sage, ERP and Excel skills a listing asks for, honestly and specifically.' },
          { q: '21. Make transferable experience legible.', a: 'If you are switching in from another field, translate past work into accounting-relevant terms.' },
          { q: '22. Keep a master CV and trim per application.', a: 'Hold everything in one document and cut it down to fit each role.' },
          { q: '23. Get a second pair of eyes on it.', a: 'A mentor or peer catches the weaknesses you cannot see in your own writing.' },
          { q: '24. Save and send it as a PDF.', a: 'A PDF preserves your layout across the different devices and systems that will open it.' },
        ],
      },
      {
        id: 'search',
        heading: 'Search the right places',
        body: [
          'Relying on a single channel is the most common reason a strong candidate misses roles that would have suited them, so watch a spread.',
        ],
        qa: [
          { q: '25. Use a focused accounting job board.', a: 'Filtering the [accounting and finance roles on our jobs board](/jobs) cuts the noise that comes with general listings.' },
          { q: '26. Watch several channels, not one.', a: 'The same role often appears in several places, and covering only one is why good candidates miss it.' },
          { q: '27. Follow firm career pages directly.', a: 'Audit and graduate intakes are frequently posted on firm sites before anywhere else.' },
          { q: '28. Set up job alerts.', a: 'Alerts get you in early, when the applicant pool is still small.' },
          { q: '29. Apply within the first few days.', a: 'Early applications are read before the shortlist fills up.' },
          { q: '30. Check general job boards too.', a: 'Broad boards still carry finance roles that are worth catching.' },
          { q: '31. Register with finance recruitment agencies.', a: 'Agencies place finance staff and can put you forward for roles that are never advertised.' },
          { q: '32. Target the Big Four graduate schemes.', a: 'They hire in cohorts with clear entry routes, so apply on their cycle.' },
          { q: '33. Look beyond Nairobi.', a: 'Roles in Mombasa, Kisumu, Nakuru and county towns often face less competition.' },
          { q: '34. Consider SACCOs, NGOs and county finance teams.', a: 'Each runs its own finance function and hires steadily, away from the crowded corporate listings.' },
          { q: '35. Filter by function and seniority.', a: 'Searching by the exact level saves you from misfit applications that go nowhere.' },
          { q: '36. Track your applications.', a: 'A simple tracker stops you double-applying or letting a follow-up slip.' },
        ],
      },
      {
        id: 'network',
        heading: 'Network and build relationships',
        body: [
          'Kenyan hiring is heavily referral-driven, so who knows your work matters as much as where you apply.',
        ],
        qa: [
          { q: '37. Tell people you are looking.', a: 'Many roles are filled through referral before they are ever advertised, so let your circle know.' },
          { q: '38. Reconnect with former colleagues and lecturers.', a: 'They know your work and often hear of openings first.' },
          { q: '39. Attend ICPAK events and CPD sessions.', a: 'They put you in a room with the people who hire accountants.' },
          { q: '40. Build a useful LinkedIn profile.', a: 'Recruiters source passively there, so make yours complete and findable.' },
          { q: '41. Follow and engage with finance recruiters.', a: 'Being on their radar surfaces you when a suitable role opens.' },
          { q: '42. Ask for informational chats, not just jobs.', a: 'A short conversation about a firm often leads to a referral later on.' },
          { q: '43. Join accounting and finance groups.', a: 'Online and local groups share leads and referrals you would not otherwise see.' },
          { q: '44. Keep in touch with your training firm.', a: 'Alumni of audit firms are often rehired or referred onward.' },
          { q: '45. Offer help before you need it.', a: 'A reputation for being useful pays back in referrals when you are the one looking.' },
          { q: '46. Get a referral into the pipeline.', a: 'A referred application is read differently from a cold one.' },
          { q: '47. Collect references you can show.', a: 'A few credible references shorten the time an employer needs to decide.' },
          { q: '48. Be easy to reach.', a: 'A current phone number and a monitored email mean you lose no opportunities to silence.' },
        ],
      },
      {
        id: 'experience',
        heading: 'Get experience when you have little',
        body: [
          'Early on the barrier is usually experience rather than qualification, and the way through is to make transferable exposure real and citable. The tactics for the first rung are set out in the guide to [entry-level accounting jobs in Kenya](/blog/entry-level-accounting-jobs-kenya).',
        ],
        qa: [
          { q: '49. Take an internship or attachment.', a: 'Even a short placement converts "no experience" into a reference and a story.' },
          { q: '50. Volunteer to keep the books of a small organisation.', a: 'A church, SACCO or small NGO gives you real, citable work to point to.' },
          { q: '51. Do a graduate trainee programme.', a: 'Structured schemes are built to take you from zero to competent.' },
          { q: '52. Freelance small bookkeeping jobs.', a: 'Filing returns or reconciling for a small trader is genuine, referenceable experience.' },
          { q: '53. Ask for finance tasks in your current job.', a: 'If your role is adjacent, volunteer for the reconciliations or reports.' },
          { q: '54. Shadow a qualified accountant.', a: 'Observed practice teaches what a textbook cannot.' },
          { q: '55. Start at a support or assistant level.', a: 'An accounts-assistant role is a legitimate first rung into the profession.' },
          { q: '56. Take a fixed-term or contract role.', a: 'Temporary work often converts to permanent and always adds to the CV.' },
          { q: '57. Build a small portfolio of work.', a: 'Anonymised samples of a reconciliation or a report show you can actually do it.' },
          { q: '58. Treat every task as a future CV line.', a: 'Frame what you do now in the terms you will want to cite later.' },
          { q: '59. Get a reference from each placement.', a: 'Ask while the work is fresh and the relationship is warm.' },
          { q: '60. Do not dismiss unpaid experience early on.', a: 'Short, real exposure can be the very thing that unlocks the first paid role.' },
        ],
      },
      {
        id: 'skills',
        heading: 'Build the skills employers pay for',
        body: [
          'Credentials get you screened in, but demonstrable skills are what convert an interview into an offer.',
        ],
        qa: [
          { q: '61. Learn accounting software properly.', a: 'QuickBooks and Sage on smaller books, an ERP at scale, and be ready to name what you know.' },
          { q: '62. Get genuinely good at Excel.', a: 'Lookups, pivot tables and clean modelling save employers time and mark you out.' },
          { q: '63. Master iTax and eTIMS.', a: 'Day-to-day Kenyan compliance runs through both, so practical fluency is a real edge.' },
          { q: '64. Know the core Kenyan taxes.', a: 'VAT, PAYE, withholding tax and corporation tax come up constantly in the work.' },
          { q: '65. Understand payroll and statutory deductions.', a: 'NSSF, SHIF and the Housing Levy are current knowledge that employers test.' },
          { q: '66. Practise reconciliations until they are automatic.', a: 'Bank and control-account reconciliation is bread-and-butter accounting work.' },
          { q: '67. Learn to close a month end.', a: 'Being trusted with the close is what moves you up the ladder.' },
          { q: '68. Sharpen your financial-statement skills.', a: 'Confident preparation and reading of the three statements is expected of you.' },
          { q: '69. Build management-accounting basics.', a: 'Budgets, variances and break-even matter more as you become more senior.' },
          { q: '70. Develop your analysis and commentary.', a: 'Explaining what the numbers mean, not just producing them, is what gets you promoted.' },
          { q: '71. Improve your written communication.', a: 'Clear emails and notes to non-finance colleagues are quietly valued.' },
          { q: '72. Work on accuracy and attention to detail.', a: 'It is the trait every accounting employer screens for, so make it visible.' },
          { q: '73. Learn to work to deadlines under pressure.', a: 'Reporting cycles are unforgiving, so show that you hold them.' },
          { q: '74. Keep learning the tools the market moves to.', a: 'Cloud accounting and automation are where demand is heading, so stay ahead of it.' },
        ],
      },
      {
        id: 'apply',
        heading: 'Apply well and follow through',
        body: [
          'A strong candidate still loses roles to a careless application, so treat each one as a task in its own right.',
        ],
        qa: [
          { q: '75. Read the listing before applying.', a: 'A large share of rejected applications simply ignored a stated requirement.' },
          { q: '76. Address the must-have requirements explicitly.', a: 'Show each key requirement is met rather than leaving it for the reader to infer.' },
          { q: '77. Apply through the pipeline, not a generic inbox.', a: 'Applying through the [jobs board](/jobs) keeps your application inside the process rather than lost.' },
          { q: '78. Keep your applications organised.', a: 'Track where and when you applied and what you sent to each.' },
          { q: '79. Follow up politely after a week.', a: 'A short, courteous nudge keeps you visible without becoming a pest.' },
          { q: '80. Do not mass-apply blindly.', a: 'Ten tailored applications beat fifty generic ones.' },
          { q: '81. Improve rejected applications and reapply later.', a: 'Ask for feedback where you can, improve, and come back for the next cycle.' },
          { q: '82. Keep your details consistent.', a: 'Your CV, LinkedIn and application should all tell the same story.' },
          { q: '83. Be honest about your level and gaps.', a: 'Overstating is caught fast in accounting, and understating loses you the role.' },
          { q: '84. Prepare your references in advance.', a: 'Have names and current contacts ready before you are asked for them.' },
        ],
      },
      {
        id: 'interview',
        heading: 'Prepare for and win the interview',
        body: [
          'The interview tests whether you can do the work and whether you will be steady doing it. Preparation is what separates a nervous candidate from a hireable one.',
        ],
        qa: [
          { q: '85. Prepare structured answers in advance.', a: 'Work through the common [accounting interview questions in Kenya](/blog/accounting-interview-questions-kenya) before the day rather than improvising in the room.' },
          { q: '86. Ready real examples for competency questions.', a: 'Two or three situation-action-result stories will cover most of what is asked.' },
          { q: '87. Revise the Kenyan compliance basics.', a: 'Questions on VAT, PAYE and eTIMS are near-certain, so have them fresh.' },
          { q: '88. Research the employer first.', a: 'Know what it does, its size and its sector before you walk in.' },
          { q: '89. Practise explaining a reconciliation that will not balance.', a: 'It is a classic technical prompt, so have a clear method ready to talk through.' },
          { q: '90. Show integrity on the judgement questions.', a: 'Employers watch closely how you handle being asked to do something you believe is wrong.' },
          { q: '91. Have your own questions ready.', a: 'Asking about the team and how the role grows signals genuine interest.' },
          { q: '92. Follow up with a thank-you note.', a: 'A brief, specific message after the interview leaves a good last impression.' },
        ],
      },
      {
        id: 'sustain',
        heading: 'Present yourself and stay the course',
        body: [
          'A job search is won over weeks, not in a day, so the last group is about presence and persistence.',
        ],
        qa: [
          { q: '93. Keep your LinkedIn current and searchable.', a: 'Use the terms recruiters search for and keep your status open to work if it is.' },
          { q: '94. Keep a profile of your work.', a: 'A tidy record of what you have done supports every application you make.' },
          { q: '95. Build a reputation for reliability.', a: 'In a referral-driven market, being known as dependable brings roles to you.' },
          { q: '96. Broaden the sectors you will consider.', a: 'The same skills open banking, manufacturing, retail, NGOs and practice.' },
          { q: '97. Consider remote and outsourced finance roles.', a: 'Kenyan accountants increasingly serve clients well beyond the country.' },
          { q: '98. Plan your route deliberately.', a: 'Map where you are against the [route to becoming an accountant in Kenya](/guides/how-to-become-an-accountant-in-kenya) and fill the gaps.' },
          { q: '99. Understand the market before you negotiate.', a: 'Read how the market is shaped in the guide to [accounting jobs in Kenya](/guides/accounting-jobs-in-kenya) so your expectations are grounded.' },
          { q: '100. Keep going through rejection.', a: 'Persistence paired with steady improvement is what eventually lands the role.' },
        ],
      },
    ],
    faqs: [
      { q: 'What is the fastest way to get an accounting job in Kenya?', a: 'There is no single fast route, but the highest-return actions are showing clear CPA progress, tailoring your CV to each listing, applying early through a focused pipeline, and using referrals, since many roles are filled before they are advertised.' },
      { q: 'Can I get an accounting job in Kenya without experience?', a: 'Yes, by targeting entry-level and support roles and making transferable exposure real: internships, attachments, volunteering to keep a small organisation books, or freelancing small bookkeeping jobs all count as citable experience.' },
      { q: 'Do I need full CPA to get an accounting job in Kenya?', a: 'Not for every role. Many junior and support listings accept CPA in progress, so state your stage clearly. Senior roles increasingly ask for completion and ICPAK membership.' },
      { q: 'Where should I apply for accounting jobs in Kenya?', a: 'Across a spread of channels: a focused accounting and finance job board, firm career pages, recruitment agencies and professional networks. The same role often appears in several, so watch more than one.' },
      { q: 'How do I stand out from other accounting applicants?', a: 'Tune your CV to the listing, name the software and taxes you know, apply early through the pipeline, secure a referral where you can, and prepare structured interview answers ahead of time.' },
    ],
  },
  {
